module.exports = (app) => {
    ...
    router.get('/students', ScLink.getStudentsByCourseAndTerm)
    router.delete('/student', ScLink.deleteStudent) //把学生从某门课程中移除（提供学生id、课程id）
    router.post('/students', ScLink.addManyStudents) //批量添加学生（提供课程id、学生id[]）注意：未实现去重，可重复添加
    router.delete('/students', ScLink.deleteManyStudents)
